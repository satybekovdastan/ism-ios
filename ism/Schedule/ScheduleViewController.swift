...
class ScheduleViewController: UIViewController, Reloadable {
    ...
    func initializeViewController() {
        listViewStoryboard = UIStoryboard(name: "ListViewController", bundle: nil)
        vc = listViewStoryboard?.instantiateInitialViewController()! as? ListViewController
    }
    ...
    func setGestureRecognizers() {
        let groupTap = UITapGestureRecognizer(target: self, action: #selector(ScheduleViewController.groupLabelTapped))
        groupLabel.isUserInteractionEnabled = true
        groupLabel.addGestureRecognizer(groupTap)

        let semesterTap = UITapGestureRecognizer(target: self, action: #selector(ScheduleViewController.semesterLabelTapped))
